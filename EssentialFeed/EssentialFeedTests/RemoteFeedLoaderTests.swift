...
final class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversItemOn200HTTPResponseWithJSONItems() {
        ...
        let items1 = FeedItem(id: UUID(), description: nil, location: nil, imageURL: URL(string: "http://a-url.com")!)
        ...
        let items2 = FeedItem(id: UUID(), description: "a description", location: "a location", imageURL: URL(string: "http://another-url.com")!)
        ...
        expect(sut, toCompleteWith: .success([items1, items2])) {
